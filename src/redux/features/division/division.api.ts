...
//         method: "POST",
//         body: formData,
//         // RTK Query automatically detects FormData and won't set Content-Type
//       }),
...
// export const { useGetAllDivisionsQuery, useAddDivisionMutation, useUpdateDivisionMutation, useDeleteDivisionMutation } =
//   divisionApi;
